        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 md:gap-16">
          ...
          <div className="w-full lg:w-1/2 relative">
             ...
             <div className="absolute -bottom-4 -left-4 md:bottom-10 md:left-10 bg-white p-4 md:p-6 rounded shadow-xl max-w-[150px] md:max-w-xs z-20">
                <p className="font-heading font-bold text-2xl md:text-4xl text-brand-600 mb-1">6+</p>
                <p className="text-gray-600 font-medium text-[10px] md:text-base">Years of Excellence in Supply Chain</p>
             </div>
          </div>

          <div className="w-full lg:w-1/2 pt-10 md:pt-0">
            <span className="text-brand-600 font-bold uppercase tracking-widest text-xs md:text-sm mb-2 block">About Our Company</span>
            <h2 className="text-2xl md:text-4xl font-heading font-bold text-gray-900 mb-6 leading-tight">Your Strategic B2B Partner for <br className="hidden md:block"/>Business Procurement</h2>
