    ...
    <div className="animate-in fade-in duration-500">
       ...
       <div className="relative h-[400px] flex items-center">
          ...
          <div className="container mx-auto px-4 relative z-20 text-white">
             ...
             <div className="flex items-center gap-4 mb-4">
                ...
                <span className="text-yellow-400 font-bold uppercase tracking-widest text-sm">Industry Focus</span>
             </div>
       ...
       <div className="container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto">
             <div className="bg-white -mt-32 relative z-20 p-8 md:p-12 rounded-xl shadow-premium border-t-4 border-yellow-500">
