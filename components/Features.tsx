      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 -mt-32">
          {[
            ...
            <div key={idx} className="bg-white p-8 rounded shadow-premium border-b-4 border-transparent hover:border-accent-500 transition-all duration-300 group">
              <div className="w-16 h-16 bg-brand-50 rounded-full flex items-center justify-center text-brand-900 mb-6 group-hover:bg-accent-500 group-hover:text-white transition-colors duration-300">
